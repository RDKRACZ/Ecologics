...
public class ModConfiguredFeatures {
    ...
    private static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<ConfiguredFeature<FC, ?>> register(String name, F feature, FC configuration) {
        return BuiltinRegistries.registerExact(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Ecologics.MOD_ID, name).toString(), new ConfiguredFeature<>(feature, configuration));
    }
}
